...
- [スキル](#スキル)
  - [業務関連](#業務関連)
    - [クラウドアーキテクチャ設計/構築](#クラウドアーキテクチャ設計構築)
    - [OS 設計/構築](#os-設計構築)
    - [コンテナ基盤設計/構築](#コンテナ基盤設計構築)
    - [IaC コード開発](#iac-コード開発)
    - [バックエンド開発](#バックエンド開発)
    - [クラウドアーキテクチャプリセールス](#クラウドアーキテクチャプリセールス)
    - [チームマネジメント/顧客折衝](#チームマネジメント顧客折衝)
  - [技術関連](#技術関連)
    - [AWS](#aws)
    - [IaC](#iac)
    - [OS](#os)
  ...
  - [保有資格](#保有資格)
- [経歴](#経歴)
  - [クラスメソッド株式会社：2022/03 - 現在](#クラスメソッド株式会社202203---現在)
    - [生成 AI チャットボットにおける RAG システム設計構築(2023/11 - 2023/12)](#生成-ai-チャットボットにおける-rag-システム設計構築202311---202312)
    - [SaaSログ連携・保管システム設計構築(2023/5 - 2024/3)](#saasログ連携保管システム設計構築20235---20243)
    - [認証システム用コンテナ基盤技術支援(2022/11 - 2023/6)](#認証システム用コンテナ基盤技術支援202211---20236)
    - [社内システム用マルチアカウント基盤技術支援](#社内システム用マルチアカウント基盤技術支援)
    - [Webサイト用RDSインスタンスタイプ自動変更システム構築（2022/7 - 2022/8)](#webサイト用rdsインスタンスタイプ自動変更システム構築20227---20228)
  - [ECサイト用AWS環境構築（2022/6 - 2022/7)](#ecサイト用aws環境構築20226---20227)
    - [CMSインフラ用AWS環境構築（2022/5 - 2022/8)](#cmsインフラ用aws環境構築20225---20228)
  - [兼松エレクトロニクス株式会社：2019/04 - 2022/02](#兼松エレクトロニクス株式会社201904---202202)
  - [基幹システム用vSphere基盤更改（2021/10 - 2022/2)](#基幹システム用vsphere基盤更改202110---20222)
  - [情報システム用vSphere基盤更改（2021/10 - 2021/12)](#情報システム用vsphere基盤更改202110---202112)
  - [基幹システム用z/VM基盤更改（2021/6 - 2021/12)](#基幹システム用zvm基盤更改20216---202112)
  - [基幹システム用VIOS基盤更改 (2021/1 - 2021/7)](#基幹システム用vios基盤更改-20211---20217)
  - [コンテナ社内検証 (2020/6 - 2022/1)](#コンテナ社内検証-20206---20221)
- [業務外活動](#業務外活動)
  - [個人開発](#個人開発)
  - [ブログ投稿](#ブログ投稿)
  - [イベント登壇](#イベント登壇)

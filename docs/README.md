...
- [DevelopersIO](https://dev.classmethod.jp/author/tsukuboshi/)
  - 主に技術記事を投稿
  - 2024/7 時点で 90 本以上の記事を作成
- [Zenn](https://zenn.dev/tsukuboshi)
  - 主に自学内容をスクラップで投稿

### イベント登壇

- [Classmethod Odyssey ONLINE 生成AI編](https://classmethod.connpass.com/event/322685/)

...
- [terraform-templates](https://github.com/tsukuboshi/terraform-templates)
  - 自身がよく設計/構築を行う AWS アーキテクチャ（モノリス、スケーラブル、マイクロサービス等）の tf ファイルテンプレートを格納したリポジトリ
- [linebot-yubaba](https://github.com/tsukuboshi/linebot-yubaba)
  - Lambda と Line Messaging API を活用した湯 婆 婆 bot のコードを格納したリポジトリ

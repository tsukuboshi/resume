...
## 職務経歴詳細(兼松エレクトロニクス株式会社：2019/04 - 2022/02）
...
### vSphere基盤の基幹システム更改(2021/10 - 2022/2)
...
### vSphere基盤の情報システム更改(2021/10 - 2021/12)

- 概要
  - 会社で利用している情報システムの老朽化にともない、新システムのインフラ構築及び既存環境からのデータ移行を実施。自身は RHEL / Apache の導入を担当。
...
### z/VM基盤の基幹システム更改(2021/6 - 2021/12)
